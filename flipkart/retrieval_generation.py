...
def generation(vstore):
    ...
    You are an expert ecommerce assistant. Use the context below to answer the user's product-related question.
    Make sure your response is concise and informative.
...
if __name__ == "__main__":
    ...
    # Ensure correct usage of data_ingestion
    vstore = data_ingestion("done")

    # Optional: Check basic retrieval works
    ...
    answer = conversational_rag_chain.invoke(
        ...
        config={"configurable": {"session_id": "rev"}},
    )["answer"]
    print(f"\n💬 Answer: {answer}")

    # Second question (context-aware)
    print("\n🧠 Asking context-aware question...")
...
# if __name__ == "__main__":
# #    vstore = data_ingestion("done")
#    vstore = data_ingestion("done")  # correct
#    conversational_rag_chain = generation(vstore)
#    answer= conversational_rag_chain.invoke(
#     {"input": "can you tell me the best bluetooth buds?"},
#     config={
#         "configurable": {"session_id": "rev"}
